...
export const CATEGORY_IDS = {
  ...
  DEMOLITION:   'a0000010-0000-4000-a000-000000000010',
...
const CATEGORIES: CategoryRow[] = [
  ...
  {
    id: CATEGORY_IDS.DEMOLITION, name: 'Demolition', slug: 'demolition',
    parent_id: null, icon_name: 'bug',
    description: 'Strip-outs, wall removal, flooring demolition, sheds, and site clearing.',
